...
import static com.vid.allvideodownloader.util.Utils.RootDirectorySnackVideo;
...
public class SnackVideoActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        if (!SharePrefs.getInstance(activity).getBoolean(SharePrefs.ISSHOWHOWTOSNACK)) {
            SharePrefs.getInstance(activity).putBoolean(SharePrefs.ISSHOWHOWTOSNACK, false);
