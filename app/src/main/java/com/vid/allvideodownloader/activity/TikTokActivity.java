...
import static com.vid.allvideodownloader.util.Utils.RootDirectoryTikTok;
...
public class TikTokActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference adsBoolean = firebaseDatabase.getReference("tiktokAds");

        adsBoolean.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.i("Tagtik",""+snapshot.child("tiktokInter").getValue());
                Log.i("Tagtik",""+snapshot.child("tiktokNative").getValue());

                tiktokInter = (boolean) snapshot.child("tiktokInter").getValue();
                tiktokNative = (boolean) snapshot.child("tiktokInter").getValue();

                if (tiktokInter == true){
                    InterstitialAdsINIT();
                }

                if (tiktokNative == true){
