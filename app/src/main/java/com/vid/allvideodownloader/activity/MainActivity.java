...
import com.vid.allvideodownloader.databinding.ActivityMainBinding;
import com.vid.allvideodownloader.util.AppLangSessionManager;
import com.vid.allvideodownloader.util.ClipboardListener;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static String idInter = "";
    static String idNative = "";
    boolean mainBanner;
    boolean mainInter;
    boolean mainNative;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference adsBoolean = firebaseDatabase.getReference("Ads");

        adsBoolean.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.i("TagBannerB", ""+snapshot.child("mainBanner").getValue());
                Log.i("TagInterstitialB", ""+snapshot.child("mainInterstitial").getValue());
                Log.i("TagNativeB", ""+snapshot.child("mainNative").getValue());

                mainBanner = (boolean) snapshot.child("mainBanner").getValue();
                mainInter = (boolean) snapshot.child("mainInterstitial").getValue();
                mainNative = (boolean) snapshot.child("mainNative").getValue();
...
//    }
    ...
    public void showNotification(String Text) {
        if (Text.contains("instagram.com") || Text.contains("facebook.com") || Text.contains("fb") || Text.contains("tiktok.com")
                ...
                || Text.contains("sharechat") || Text.contains("roposo")
